    ...
    function lexPlain(isInQuote) {
        ...
        while (true) {
            ...
            switch (characterEaten) {
                ...
                case 33:
                    if (sourceContext_1.tryEat(124)) funKeyword(115);else handleName();
                    break;
                case 36:
                    if (sourceContext_1.tryEat2(33, 124)) funKeyword(119);else if (sourceContext_1.tryEat(124)) funKeyword(118);else handleName();
                    break;
                case 42:
                    if (sourceContext_1.tryEat2(33, 124)) funKeyword(123);else if (sourceContext_1.tryEat(124)) funKeyword(122);else handleName();
                    break;
                case 124:
                    ...
                    } else if (sourceContext_1.tryEat(124)) sourceContext_1.skipRestOfLine();else funKeyword(114);
                    break;
                case 45:
                ...
                case 46:
                    {
                        if (sourceContext_1.peek() === 32 || sourceContext_1.peek() === 10) {
                            groupContext_1.closeSpaceOKIfEmpty(startPos());
                            keyword(140);
                        } else if (sourceContext_1.tryEat(124)) funKeyword(116);else if (sourceContext_1.tryEat2(33, 124)) funKeyword(117);else if (sourceContext_1.tryEat2(42, 124)) funKeyword(124);else if (sourceContext_1.tryEat3(42, 33, 124)) funKeyword(125);else if (sourceContext_1.tryEat(46)) {
