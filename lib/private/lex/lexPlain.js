    ...
    function lexPlain(isInQuote) {
        ...
        while (true) {
            ...
            switch (characterEaten) {
                ...
                case 10:
                    {
                        ...
                        if (indent > oldIndent) {
                            ...
                            const l = loc();
                            if (util_1.isEmpty(groupContext_1.curGroup.subTokens) || !Keyword_1.isKeyword(126, util_1.last(groupContext_1.curGroup.subTokens))) {
                ...
                case 33:
                    if (sourceContext_1.tryEat(124)) funKeyword(109);else handleName();
                    break;
                case 36:
                    if (sourceContext_1.tryEat2(33, 124)) funKeyword(113);else if (sourceContext_1.tryEat(124)) funKeyword(112);else handleName();
                    break;
                case 42:
                    if (sourceContext_1.tryEat2(33, 124)) funKeyword(117);else if (sourceContext_1.tryEat(124)) funKeyword(116);else handleName();
                    break;
                case 124:
                    ...
                    } else if (sourceContext_1.tryEat(124)) sourceContext_1.skipRestOfLine();else funKeyword(108);
                    break;
                case 45:
                ...
                case 46:
                    {
                        if (sourceContext_1.peek() === 32 || sourceContext_1.peek() === 10) {
                            groupContext_1.closeSpaceOKIfEmpty(startPos());
                            keyword(135);
                        } else if (sourceContext_1.tryEat(124)) funKeyword(110);else if (sourceContext_1.tryEat2(33, 124)) funKeyword(111);else if (sourceContext_1.tryEat2(42, 124)) funKeyword(118);else if (sourceContext_1.tryEat3(42, 33, 124)) funKeyword(119);else if (sourceContext_1.tryEat(46)) {
                            if (sourceContext_1.tryEat(46)) keyword(97);else keyword(96);
                        } else keyword(95);
                        break;
                    }
                case 58:
                    if (sourceContext_1.tryEat(61)) keyword(127);else keyword(90);
                    break;
                case 39:
                    keyword(146);
                    break;
