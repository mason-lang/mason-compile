    ...
    function lexPlain(isInQuote) {
        ...
        while (true) {
            ...
            switch (characterEaten) {
                ...
                case 10:
                    {
                        ...
                        if (indent > oldIndent) {
                            ...
                            const l = loc();
                            if (util_1.isEmpty(groupContext_1.curGroup.subTokens) || !Keyword_1.isKeyword(133, util_1.last(groupContext_1.curGroup.subTokens))) {
                ...
                case 33:
                    if (sourceContext_1.tryEat(92)) funKeyword(116);else handleName();
                    break;
                case 36:
                    if (sourceContext_1.tryEat2(33, 92)) funKeyword(120);else if (sourceContext_1.tryEat(92)) funKeyword(119);else handleName();
                    break;
                case 42:
                    if (sourceContext_1.tryEat2(33, 92)) funKeyword(124);else if (sourceContext_1.tryEat(92)) funKeyword(123);else handleName();
                    break;
                case 92:
                    funKeyword(115);
                    break;
                ...
                case 46:
                    {
                        if (sourceContext_1.peek() === 32 || sourceContext_1.peek() === 10) {
                            groupContext_1.closeSpaceOKIfEmpty(startPos());
                            keyword(140);
                        } else if (sourceContext_1.tryEat(92)) funKeyword(117);else if (sourceContext_1.tryEat2(33, 92)) funKeyword(118);else if (sourceContext_1.tryEat2(42, 92)) funKeyword(125);else if (sourceContext_1.tryEat3(42, 33, 92)) funKeyword(126);else if (sourceContext_1.tryEat(46)) {
                            if (sourceContext_1.tryEat(46)) keyword(104);else keyword(103);
                        } else keyword(102);
                        break;
                    }
                case 58:
                    if (sourceContext_1.tryEat(61)) keyword(89);else keyword(97);
                    break;
                case 39:
                    keyword(164);
                    break;
