...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'esast/lib/Loc', '../context', '../token/Group', '../token/Keyword', '../token/Token', '../util', './groupContext', './lexAfterPeriod', './lexIndent', './lexName', './lexNumber', './lexQuote', './sourceContext', './util'], factory);
    }
        ...
        while (true) {
            ...
            switch (characterEaten) {
                ...
                case 124:
                    ...
                    if (isDocComment) {
                        const text = sourceContext_1.takeRestOfLine();
                    ...
                    break;
                case 45:
                    if (sourceContext_1.isDigitDecimal(sourceContext_1.peek())) lexNumber_1.default(startPos());else handleName();
                    break;
                case 48:
                case 49:
                case 50:
