(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'esast/lib/Loc', 'op/Op', '../context', '../token/Keyword', '../token/Token', './groupContext', './sourceContext', './util'], factory);
    }
    ...
    function lexName(startPos, isInterpolation) {
        const name = sourceContext_1.takeName();
