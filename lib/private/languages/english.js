(function (factory) {
    ...
    const english = {
        ...
        reservedWord: token => `Reserved word ${ util_2.showToken(token) }.`,
        ...
        ambiguousForSK: `Can't tell if ${ util_2.showKeyword(111) } is a statement. ` + `Some ${ util_2.showKeyword(91) }s have a value, others don't.`,
        ...
        misplacedSpreadVal: `Can only spread in call, ${ util_2.showKeyword(137) }, or ${ util_2.showGroupType(Group_1.GroupBracket) }.`,
