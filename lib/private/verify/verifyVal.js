(function (factory) {
    ...
    const verifyMethod_1 = require('./verifyMethod');
    ...
    function verifyVal(_) {
        ...
        } else if (_ instanceof Method_1.default) verifyMethod_1.default(_);else if (_ instanceof Quote_1.MsRegExp) verifyQuote_1.verifyRegExp(_);else if (_ instanceof Call_1.New) verifyCall_1.verifyNew(_);else if (_ instanceof Val_1.NumberLiteral) {} else if (_ instanceof Val_1.ObjSimple) {
            const keys = new Set();
