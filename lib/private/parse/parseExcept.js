...
(function (factory) {
    ...
    function parseExcept(tokens) {
        const lines = parseBlock_1.justBlock(105, tokens);
    ...
    function takeCatches(lines) {
        ...
        while (!lines.isEmpty()) {
            const line = lines.headSlice();
            if (!Keyword_1.isKeyword(93, line.head())) break;
    ...
    function opTakeElse(lines) {
        ...
        return Keyword_1.isKeyword(104, tokenElse) ? [parseBlock_1.parseJustBlock(104, line.tail()), lines.tail()] : [null, lines];
    }
    function parseOpFinally(lines) {
        ...
        return parseBlock_1.parseJustBlock(108, line.tail());
    }
});
