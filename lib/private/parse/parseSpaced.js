...
(function (factory) {
    ...
    function parseAmpersand(loc, tokens) {
        ...
        var _ref = (() => {
            if (h instanceof Group_1.GroupParenthesis) return [new Fun_1.FunSimple(loc, parseExpr_1.default(Slice_1.Tokens.of(h))), tail];else if (Keyword_1.isKeyword(101, h)) {
                const h2 = tail.head();
