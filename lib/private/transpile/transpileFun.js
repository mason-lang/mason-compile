(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'esast/lib/Expression', 'esast/lib/Function', 'esast/lib/Identifier', 'esast/lib/Literal', 'esast/lib/Statement', 'esast-create-util/lib/util', 'op/Op', '../context', '../ast/Fun', '../util', './context', './esast-constants', './ms', './transpileBlock', './transpileLocals', './transpileMemberName', './transpileVal', './util'], factory);
    }
    ...
    function transpileFunNoLoc(_) {
        ...
        } else if (_ instanceof Fun_1.FunSimple) return focusFun(transpileVal_1.default(_.value));else throw new Error(_.constructor.name);
    }
