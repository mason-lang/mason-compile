(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'esast/lib/Expression', 'esast/lib/Identifier', 'esast/lib/Literal', 'esast/lib/ObjectExpression', 'op/Op', '../ast/Await', '../ast/Block', '../ast/Call', '../ast/Case', '../ast/Class', '../ast/booleans', '../ast/Del', '../ast/errors', '../ast/Fun', '../ast/locals', '../ast/Loop', '../ast/Method', '../ast/Quote', '../ast/Switch', '../ast/Trait', '../ast/Val', '../ast/With', '../ast/YieldLike', './context', './ms', './transpileAwait', './transpileBlock', './transpileBooleans', './transpileCall', './transpileCase', './transpileClass', './transpileDel', './transpileErrors', './transpileFun', './transpileLocals', './transpileLoop', './transpileMemberName', './transpileMethod', './transpileOperator', './transpileQuote', './transpileSwitch', './transpileTrait', './transpileWith', './transpileYieldLike', './util'], factory);
    }
    ...
    var transpileOperator_1 = require('./transpileOperator');
    ...
    function transpileValNoLoc(_) {
        ...
        } else if (_ instanceof Method_1.default) return transpileMethod_1.transpileMethodNoLoc(_);else if (_ instanceof Quote_1.MsRegExp) return transpileQuote_1.transpileRegExpNoLoc(_);else if (_ instanceof Call_1.New) return transpileCall_1.transpileNewNoLoc(_);else if (_ instanceof Val_1.NumberLiteral) {
