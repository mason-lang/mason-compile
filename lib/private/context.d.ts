...
export declare let compileOptions: CompileOptions;
export declare let pathOptions: PathOptions;
export declare function withContext<A>(options: CompileOptions, filename: string, getResult: () => A): WarningsAnd<A>;
