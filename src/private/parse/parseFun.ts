...
import {Block, Val, Fun, FunAbstract, FunLike, Funs, LocalDeclare} from '../MsAst'
import {GroupSpace, isAnyKeyword, isKeyword, Keywords} from '../Token'
...
/** Parse a [[FunLike]]. */
export function parseFunLike(keywordKind: Keywords, tokens: Tokens): FunLike {
	const [isThisFun, isDo, kind] = funKind(keywordKind)
	const [opReturnType, rest] = tryTakeReturnType(tokens)
...
@param [includeMemberArgs]
	...
	e.g.: `construct! .x .y`
*/
export function funArgsAndBlock(tokens: Tokens, isVal: boolean, includeMemberArgs: boolean = false)
	: {args: Array<LocalDeclare>, opRestArg: Op<LocalDeclare>, memberArgs:Array<LocalDeclare>, block: Block} {
