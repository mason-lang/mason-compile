...
import {Assert, AssignSingle, AssignDestructure, BagEntry, Break, Class, Do, For, ForBag, Fun, Ignore, isDo, isVal, LineContent, LocalMutate, MapEntry,
	MemberSet, Method, ObjEntryAssign, ObjEntryPlain, Pass, SetSub, SpecialDo, Trait, TraitDo} from '../MsAst'
...
import SK from './SK'
import {setName, verifyName} from './util'
...
//???
export function verifyDoP(_: LineContent): void {
	if (isDo(_))
		verifyDo(_)
	else
