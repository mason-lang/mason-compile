	...
	(0, _util.implementMany)(MsAstTypes, 'verify', {
		...
		Fun(sk) {
			...
			(0, _locals.withBlockLocals)(() => {
				(0, _context2.withInFunKind)(this.kind, () => {
