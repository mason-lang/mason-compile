...
(function (global, factory) {
	...
	function verifyBlock(sk) {
		if (sk === _SK2.default.Do) verifyDoBlock(this);else {
			(0, _context.check)(!(0, _util.isEmpty)(this.lines), 'blockNeedsContent');
