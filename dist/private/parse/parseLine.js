...
(function (global, factory) {
	...
	function parseLine(tokens) {
		...
		if (head instanceof _Token.Keyword) switch (head.kind) {
			...
			case _Token.Keywords.TraitDo:
				return (0, _parse.parseTraitDo)(rest());
